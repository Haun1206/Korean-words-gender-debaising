...
def main():
    ...
    print("No_gender_words")
    print(len(no_gender_words))
    stereotype_words['female'], stereotype_words['male'] = \
              make_pair_words(hp.stereotype_words, emb)
    print("Stereotype")
    print(len(stereotype_words['female']))  
    print(len(stereotype_words['male']))         
    gender_words['female'], gender_words['male'] = \
              make_pair_words(hp.gender_words, emb)
    print("Gender_words")
    print(len(gender_words['female']))  
    print(len(gender_words['male'])) 
